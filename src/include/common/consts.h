...
constexpr size_t HASH_TABLE_BITMAP_SIZE = (HASH_TABLE_REGION_SIZE + 7) / 8;
constexpr size_t HASH_TABLE_DIRECTORY_OFFSET = HASH_TABLE_BITMAP_SIZE;
static const size_t HASH_TABLE_DIRECTORY_SIZE = (pow(2, HASH_TABLE_MAX_GLOBAL_DEPTH) + HASH_TABLE_DIRECTORY_ARRAY_SIZE - 1) / HASH_TABLE_DIRECTORY_ARRAY_SIZE;
